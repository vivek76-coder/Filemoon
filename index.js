...
const { signUp, login, uploadImage, fetchImage } = require("./controller/user.controller")
...
app.post('/api/profile-picture', AuthMiddleware, upload.single('picture'), uploadImage)
